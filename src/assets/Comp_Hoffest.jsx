  ...
  return (
    <Box sx={{ flexGrow: 1, mt:'5px'}}>
      <Grid container spacing={2}>
        ...
        <Grid xs={12} lg={4}>
          <Item sx={{backgroundColor:"primary.dark", height:'100%', padding:'0'}}>
{                      <Typography fontSize={'xx-large'}>Hoffest 2023</Typography>
}                      <CardMedia 
                        component="img"
